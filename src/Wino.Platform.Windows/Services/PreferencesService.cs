...
public partial class PreferencesService(IConfigurationService configurationService) : ObservableObject, IPreferencesService
{
    ...
    private static PreferenceAccessor[] GetGeneratedSyncablePreferenceProperties()
        => new PreferenceAccessor[]
        {
        new PreferenceAccessor(
            "IsLoggingEnabled",
            typeof(bool),
            static service => service.IsLoggingEnabled,
            static (service, value) => service.IsLoggingEnabled = (bool)value!),
        new PreferenceAccessor(
            "CurrentLanguage",
            typeof(AppLanguage),
            static service => service.CurrentLanguage,
            static (service, value) => service.CurrentLanguage = (AppLanguage)value!),
        new PreferenceAccessor(
            "IsStoreUpdateNotificationsEnabled",
            typeof(bool),
            static service => service.IsStoreUpdateNotificationsEnabled,
            static (service, value) => service.IsStoreUpdateNotificationsEnabled = (bool)value!),
        new PreferenceAccessor(
            "IsSystemTrayIconEnabled",
            typeof(bool),
            static service => service.IsSystemTrayIconEnabled,
            static (service, value) => service.IsSystemTrayIconEnabled = (bool)value!),
        new PreferenceAccessor(
            "IsCompanionEnabled",
            typeof(bool),
            static service => service.IsCompanionEnabled,
            static (service, value) => service.IsCompanionEnabled = (bool)value!),
        new PreferenceAccessor(
            "CompanionUnreadMessageBehavior",
            typeof(CompanionUnreadMessageBehavior),
            static service => service.CompanionUnreadMessageBehavior,
            static (service, value) => service.CompanionUnreadMessageBehavior = (CompanionUnreadMessageBehavior)value!),
        new PreferenceAccessor(
            "ShowCalendarInCompanion",
            typeof(bool),
            static service => service.ShowCalendarInCompanion,
            static (service, value) => service.ShowCalendarInCompanion = (bool)value!),
        new PreferenceAccessor(
            "ShowUnreadMailInCompanion",
            typeof(bool),
            static service => service.ShowUnreadMailInCompanion,
            static (service, value) => service.ShowUnreadMailInCompanion = (bool)value!),
        new PreferenceAccessor(
            "ShowTasksInCompanion",
            typeof(bool),
            static service => service.ShowTasksInCompanion,
            static (service, value) => service.ShowTasksInCompanion = (bool)value!),
        new PreferenceAccessor(
            "ShowFavoriteContactsInCompanion",
            typeof(bool),
            static service => service.ShowFavoriteContactsInCompanion,
            static (service, value) => service.ShowFavoriteContactsInCompanion = (bool)value!),
        new PreferenceAccessor(
            "IsCompanionHotKeyEnabled",
            typeof(bool),
            static service => service.IsCompanionHotKeyEnabled,
            static (service, value) => service.IsCompanionHotKeyEnabled = (bool)value!),
        new PreferenceAccessor(
            "CompanionHotKeyKey",
            typeof(string),
            static service => service.CompanionHotKeyKey,
            static (service, value) => service.CompanionHotKeyKey = (string)value!),
        new PreferenceAccessor(
            "CompanionHotKeyModifiers",
            typeof(ModifierKeys),
            static service => service.CompanionHotKeyModifiers,
            static (service, value) => service.CompanionHotKeyModifiers = (ModifierKeys)value!),
        new PreferenceAccessor(
            "NotificationSnoozePreset",
            typeof(NotificationSnoozePreset),
            static service => service.NotificationSnoozePreset,
            static (service, value) => service.NotificationSnoozePreset = (NotificationSnoozePreset)value!),
        new PreferenceAccessor(
            "NotificationSnoozeUntilUtcTicks",
            typeof(long),
            static service => service.NotificationSnoozeUntilUtcTicks,
            static (service, value) => service.NotificationSnoozeUntilUtcTicks = (long)value!),
        new PreferenceAccessor(
            "LastUsedSnoozePreset",
            typeof(NotificationSnoozePreset),
            static service => service.LastUsedSnoozePreset,
            static (service, value) => service.LastUsedSnoozePreset = (NotificationSnoozePreset)value!),
        new PreferenceAccessor(
            "AreQuietHoursEnabled",
            typeof(bool),
            static service => service.AreQuietHoursEnabled,
            static (service, value) => service.AreQuietHoursEnabled = (bool)value!),
        new PreferenceAccessor(
            "QuietHoursStart",
            typeof(TimeSpan),
            static service => service.QuietHoursStart,
            static (service, value) => service.QuietHoursStart = (TimeSpan)value!),
        new PreferenceAccessor(
            "QuietHoursEnd",
            typeof(TimeSpan),
            static service => service.QuietHoursEnd,
            static (service, value) => service.QuietHoursEnd = (TimeSpan)value!),
        new PreferenceAccessor(
            "QuietHoursDays",
            typeof(QuietHoursDays),
            static service => service.QuietHoursDays,
            static (service, value) => service.QuietHoursDays = (QuietHoursDays)value!),
        new PreferenceAccessor(
            "SnoozeWhilePresenting",
            typeof(bool),
            static service => service.SnoozeWhilePresenting,
            static (service, value) => service.SnoozeWhilePresenting = (bool)value!),
        new PreferenceAccessor(
            "AreNewMailNotificationsEnabled",
            typeof(bool),
            static service => service.AreNewMailNotificationsEnabled,
            static (service, value) => service.AreNewMailNotificationsEnabled = (bool)value!),
        new PreferenceAccessor(
            "MailNotificationScope",
            typeof(MailNotificationScope),
            static service => service.MailNotificationScope,
            static (service, value) => service.MailNotificationScope = (MailNotificationScope)value!),
        new PreferenceAccessor(
            "MailNotificationContent",
            typeof(MailNotificationContent),
            static service => service.MailNotificationContent,
            static (service, value) => service.MailNotificationContent = (MailNotificationContent)value!),
        new PreferenceAccessor(
            "AreCalendarRemindersEnabled",
            typeof(bool),
            static service => service.AreCalendarRemindersEnabled,
            static (service, value) => service.AreCalendarRemindersEnabled = (bool)value!),
        new PreferenceAccessor(
            "AreTaskRemindersEnabled",
            typeof(bool),
            static service => service.AreTaskRemindersEnabled,
            static (service, value) => service.AreTaskRemindersEnabled = (bool)value!),
        new PreferenceAccessor(
            "TaskReminderTiming",
            typeof(TaskReminderTiming),
            static service => service.TaskReminderTiming,
            static (service, value) => service.TaskReminderTiming = (TaskReminderTiming)value!),
        new PreferenceAccessor(
            "TaskReminderSnoozeMinutes",
            typeof(int),
            static service => service.TaskReminderSnoozeMinutes,
            static (service, value) => service.TaskReminderSnoozeMinutes = (int)value!),
        new PreferenceAccessor(
            "TaskNotificationSoundEvent",
            typeof(NotificationSoundEvent),
            static service => service.TaskNotificationSoundEvent,
            static (service, value) => service.TaskNotificationSoundEvent = (NotificationSoundEvent)value!),
        new PreferenceAccessor(
            "AppCloseBehavior",
            typeof(AppCloseBehavior),
            static service => service.AppCloseBehavior,
            static (service, value) => service.AppCloseBehavior = (AppCloseBehavior)value!),
        new PreferenceAccessor(
            "MailTimeFormatPreference",
            typeof(TimeFormatPreference),
            static service => service.MailTimeFormatPreference,
            static (service, value) => service.MailTimeFormatPreference = (TimeFormatPreference)value!),
        new PreferenceAccessor(
            "DefaultSearchMode",
            typeof(SearchMode),
            static service => service.DefaultSearchMode,
            static (service, value) => service.DefaultSearchMode = (SearchMode)value!),
        new PreferenceAccessor(
            "EmailSyncIntervalMinutes",
            typeof(int),
            static service => service.EmailSyncIntervalMinutes,
            static (service, value) => service.EmailSyncIntervalMinutes = (int)value!),
        new PreferenceAccessor(
            "IsUndoSendingDraftsEnabled",
            typeof(bool),
            static service => service.IsUndoSendingDraftsEnabled,
            static (service, value) => service.IsUndoSendingDraftsEnabled = (bool)value!),
        new PreferenceAccessor(
            "UndoSendingDraftsIntervalInSeconds",
            typeof(int),
            static service => service.UndoSendingDraftsIntervalInSeconds,
            static (service, value) => service.UndoSendingDraftsIntervalInSeconds = (int)value!),
        new PreferenceAccessor(
            "IsUndoDeletingMailsEnabled",
            typeof(bool),
            static service => service.IsUndoDeletingMailsEnabled,
            static (service, value) => service.IsUndoDeletingMailsEnabled = (bool)value!),
        new PreferenceAccessor(
            "UndoDeletingMailsIntervalInSeconds",
            typeof(int),
            static service => service.UndoDeletingMailsIntervalInSeconds,
            static (service, value) => service.UndoDeletingMailsIntervalInSeconds = (int)value!),
        new PreferenceAccessor(
            "MailItemDisplayMode",
            typeof(MailListDisplayMode),
            static service => service.MailItemDisplayMode,
            static (service, value) => service.MailItemDisplayMode = (MailListDisplayMode)value!),
        new PreferenceAccessor(
            "IsCompactAccountMenuItemEnabled",
            typeof(bool),
            static service => service.IsCompactAccountMenuItemEnabled,
            static (service, value) => service.IsCompactAccountMenuItemEnabled = (bool)value!),
        new PreferenceAccessor(
            "IsDailyBriefingShowingIgnored",
            typeof(bool),
            static service => service.IsDailyBriefingShowingIgnored,
            static (service, value) => service.IsDailyBriefingShowingIgnored = (bool)value!),
        new PreferenceAccessor(
            "MarkAsPreference",
            typeof(MailMarkAsOption),
            static service => service.MarkAsPreference,
            static (service, value) => service.MarkAsPreference = (MailMarkAsOption)value!),
        new PreferenceAccessor(
            "MarkAsDelay",
            typeof(int),
            static service => service.MarkAsDelay,
            static (service, value) => service.MarkAsDelay = (int)value!),
        new PreferenceAccessor(
            "IsHardDeleteProtectionEnabled",
            typeof(bool),
            static service => service.IsHardDeleteProtectionEnabled,
            static (service, value) => service.IsHardDeleteProtectionEnabled = (bool)value!),
        new PreferenceAccessor(
            "IsShowEmptyJunkFolderEnabled",
            typeof(bool),
            static service => service.IsShowEmptyJunkFolderEnabled,
            static (service, value) => service.IsShowEmptyJunkFolderEnabled = (bool)value!),
        new PreferenceAccessor(
            "IsThreadingEnabled",
            typeof(bool),
            static service => service.IsThreadingEnabled,
            static (service, value) => service.IsThreadingEnabled = (bool)value!),
        new PreferenceAccessor(
            "IsNewestThreadMailFirst",
            typeof(bool),
            static service => service.IsNewestThreadMailFirst,
            static (service, value) => service.IsNewestThreadMailFirst = (bool)value!),
        new PreferenceAccessor(
            "IsShowSenderPicturesEnabled",
            typeof(bool),
            static service => service.IsShowSenderPicturesEnabled,
            static (service, value) => service.IsShowSenderPicturesEnabled = (bool)value!),
        new PreferenceAccessor(
            "IsShowPreviewEnabled",
            typeof(bool),
            static service => service.IsShowPreviewEnabled,
            static (service, value) => service.IsShowPreviewEnabled = (bool)value!),
        new PreferenceAccessor(
            "IsMailListGroupHeadersEnabled",
            typeof(bool),
            static service => service.IsMailListGroupHeadersEnabled,
            static (service, value) => service.IsMailListGroupHeadersEnabled = (bool)value!),
        new PreferenceAccessor(
            "IsOtherInboxUnreadNoticeEnabled",
            typeof(bool),
            static service => service.IsOtherInboxUnreadNoticeEnabled,
            static (service, value) => service.IsOtherInboxUnreadNoticeEnabled = (bool)value!),
        new PreferenceAccessor(
            "RenderImages",
            typeof(bool),
            static service => service.RenderImages,
            static (service, value) => service.RenderImages = (bool)value!),
        new PreferenceAccessor(
            "RenderStyles",
            typeof(bool),
            static service => service.RenderStyles,
            static (service, value) => service.RenderStyles = (bool)value!),
        new PreferenceAccessor(
            "RenderPlaintextLinks",
            typeof(bool),
            static service => service.RenderPlaintextLinks,
            static (service, value) => service.RenderPlaintextLinks = (bool)value!),
        new PreferenceAccessor(
            "IsSwipeActionsEnabled",
            typeof(bool),
            static service => service.IsSwipeActionsEnabled,
            static (service, value) => service.IsSwipeActionsEnabled = (bool)value!),
        new PreferenceAccessor(
            "RightSwipeOperation",
            typeof(MailOperation),
            static service => service.RightSwipeOperation,
            static (service, value) => service.RightSwipeOperation = (MailOperation)value!),
        new PreferenceAccessor(
            "LeftSwipeOperation",
            typeof(MailOperation),
            static service => service.LeftSwipeOperation,
            static (service, value) => service.LeftSwipeOperation = (MailOperation)value!),
        new PreferenceAccessor(
            "IsHoverActionsEnabled",
            typeof(bool),
            static service => service.IsHoverActionsEnabled,
            static (service, value) => service.IsHoverActionsEnabled = (bool)value!),
        new PreferenceAccessor(
            "LeftHoverAction",
            typeof(MailOperation),
            static service => service.LeftHoverAction,
            static (service, value) => service.LeftHoverAction = (MailOperation)value!),
        new PreferenceAccessor(
            "CenterHoverAction",
            typeof(MailOperation),
            static service => service.CenterHoverAction,
            static (service, value) => service.CenterHoverAction = (MailOperation)value!),
        new PreferenceAccessor(
            "RightHoverAction",
            typeof(MailOperation),
            static service => service.RightHoverAction,
            static (service, value) => service.RightHoverAction = (MailOperation)value!),
        new PreferenceAccessor(
            "HoverActionAnimation",
            typeof(MailHoverActionAnimation),
            static service => service.HoverActionAnimation,
            static (service, value) => service.HoverActionAnimation = (MailHoverActionAnimation)value!),
        new PreferenceAccessor(
            "HoverActionPosition",
            typeof(MailHoverActionPosition),
            static service => service.HoverActionPosition,
            static (service, value) => service.HoverActionPosition = (MailHoverActionPosition)value!),
        new PreferenceAccessor(
            "HoverActionButtonSize",
            typeof(MailHoverActionButtonSize),
            static service => service.HoverActionButtonSize,
            static (service, value) => service.HoverActionButtonSize = (MailHoverActionButtonSize)value!),
        new PreferenceAccessor(
            "StartupEntityId",
            typeof(Guid?),
            static service => service.StartupEntityId,
            static (service, value) => service.StartupEntityId = (Guid?)value!),
        new PreferenceAccessor(
            "IsTaskbarBadgeLaunchNavigationEnabled",
            typeof(bool),
            static service => service.IsTaskbarBadgeLaunchNavigationEnabled,
            static (service, value) => service.IsTaskbarBadgeLaunchNavigationEnabled = (bool)value!),
        new PreferenceAccessor(
            "FirstMailNotificationAction",
            typeof(MailOperation),
            static service => service.FirstMailNotificationAction,
            static (service, value) => service.FirstMailNotificationAction = (MailOperation)value!),
        new PreferenceAccessor(
            "SecondMailNotificationAction",
            typeof(MailOperation),
            static service => service.SecondMailNotificationAction,
            static (service, value) => service.SecondMailNotificationAction = (MailOperation)value!),
        new PreferenceAccessor(
            "MailNotificationSoundEvent",
            typeof(NotificationSoundEvent),
            static service => service.MailNotificationSoundEvent,
            static (service, value) => service.MailNotificationSoundEvent = (NotificationSoundEvent)value!),
        new PreferenceAccessor(
            "ReaderFont",
            typeof(string),
            static service => service.ReaderFont,
            static (service, value) => service.ReaderFont = (string)value!),
        new PreferenceAccessor(
            "ReaderFontSize",
            typeof(int),
            static service => service.ReaderFontSize,
            static (service, value) => service.ReaderFontSize = (int)value!),
        new PreferenceAccessor(
            "ComposerFont",
            typeof(string),
            static service => service.ComposerFont,
            static (service, value) => service.ComposerFont = (string)value!),
        new PreferenceAccessor(
            "ComposerFontSize",
            typeof(int),
            static service => service.ComposerFontSize,
            static (service, value) => service.ComposerFontSize = (int)value!),
        new PreferenceAccessor(
            "IsComposerSpellCheckEnabled",
            typeof(bool),
            static service => service.IsComposerSpellCheckEnabled,
            static (service, value) => service.IsComposerSpellCheckEnabled = (bool)value!),
        new PreferenceAccessor(
            "ComposerSpellCheckLanguageCode",
            typeof(string),
            static service => service.ComposerSpellCheckLanguageCode,
            static (service, value) => service.ComposerSpellCheckLanguageCode = (string)value!),
        new PreferenceAccessor(
            "AutoSelectNextItem",
            typeof(bool),
            static service => service.AutoSelectNextItem,
            static (service, value) => service.AutoSelectNextItem = (bool)value!),
        new PreferenceAccessor(
            "IsMailListActionBarEnabled",
            typeof(bool),
            static service => service.IsMailListActionBarEnabled,
            static (service, value) => service.IsMailListActionBarEnabled = (bool)value!),
        new PreferenceAccessor(
            "IsShowActionLabelsEnabled",
            typeof(bool),
            static service => service.IsShowActionLabelsEnabled,
            static (service, value) => service.IsShowActionLabelsEnabled = (bool)value!),
        new PreferenceAccessor(
            "IsGravatarEnabled",
            typeof(bool),
            static service => service.IsGravatarEnabled,
            static (service, value) => service.IsGravatarEnabled = (bool)value!),
        new PreferenceAccessor(
            "IsFaviconEnabled",
            typeof(bool),
            static service => service.IsFaviconEnabled,
            static (service, value) => service.IsFaviconEnabled = (bool)value!),
        new PreferenceAccessor(
            "AccountNicknamePosition",
            typeof(AccountNicknamePosition),
            static service => service.AccountNicknamePosition,
            static (service, value) => service.AccountNicknamePosition = (AccountNicknamePosition)value!),
        new PreferenceAccessor(
            "AiDefaultTranslationLanguageCode",
            typeof(string),
            static service => service.AiDefaultTranslationLanguageCode,
            static (service, value) => service.AiDefaultTranslationLanguageCode = (string)value!),
        new PreferenceAccessor(
            "AiSummarizeLanguageCode",
            typeof(string),
            static service => service.AiSummarizeLanguageCode,
            static (service, value) => service.AiSummarizeLanguageCode = (string)value!),
        new PreferenceAccessor(
            "IsNavigationPaneOpened",
            typeof(bool),
            static service => service.IsNavigationPaneOpened,
            static (service, value) => service.IsNavigationPaneOpened = (bool)value!),
        new PreferenceAccessor(
            "IsWinoAccountButtonHidden",
            typeof(bool),
            static service => service.IsWinoAccountButtonHidden,
            static (service, value) => service.IsWinoAccountButtonHidden = (bool)value!),
        new PreferenceAccessor(
            "FirstDayOfWeek",
            typeof(DayOfWeek),
            static service => service.FirstDayOfWeek,
            static (service, value) => service.FirstDayOfWeek = (DayOfWeek)value!),
        new PreferenceAccessor(
            "IsWorkingHoursEnabled",
            typeof(bool),
            static service => service.IsWorkingHoursEnabled,
            static (service, value) => service.IsWorkingHoursEnabled = (bool)value!),
        new PreferenceAccessor(
            "WorkingHourStart",
            typeof(TimeSpan),
            static service => service.WorkingHourStart,
            static (service, value) => service.WorkingHourStart = (TimeSpan)value!),
        new PreferenceAccessor(
            "WorkingHourEnd",
            typeof(TimeSpan),
            static service => service.WorkingHourEnd,
            static (service, value) => service.WorkingHourEnd = (TimeSpan)value!),
        new PreferenceAccessor(
            "WorkingDayStart",
            typeof(DayOfWeek),
            static service => service.WorkingDayStart,
            static (service, value) => service.WorkingDayStart = (DayOfWeek)value!),
        new PreferenceAccessor(
            "WorkingDayEnd",
            typeof(DayOfWeek),
            static service => service.WorkingDayEnd,
            static (service, value) => service.WorkingDayEnd = (DayOfWeek)value!),
        new PreferenceAccessor(
            "HourHeight",
            typeof(double),
            static service => service.HourHeight,
            static (service, value) => service.HourHeight = (double)value!),
        new PreferenceAccessor(
            "CalendarTimedDayHeaderDateFormat",
            typeof(string),
            static service => service.CalendarTimedDayHeaderDateFormat,
            static (service, value) => service.CalendarTimedDayHeaderDateFormat = (string)value!),
        new PreferenceAccessor(
            "CalendarSyncIntervalMinutes",
            typeof(int),
            static service => service.CalendarSyncIntervalMinutes,
            static (service, value) => service.CalendarSyncIntervalMinutes = (int)value!),
        new PreferenceAccessor(
            "CalendarTimeFormatPreference",
            typeof(TimeFormatPreference),
            static service => service.CalendarTimeFormatPreference,
            static (service, value) => service.CalendarTimeFormatPreference = (TimeFormatPreference)value!),
        new PreferenceAccessor(
            "DefaultReminderDurationInSeconds",
            typeof(long),
            static service => service.DefaultReminderDurationInSeconds,
            static (service, value) => service.DefaultReminderDurationInSeconds = (long)value!),
        new PreferenceAccessor(
            "DefaultSnoozeDurationInMinutes",
            typeof(int),
            static service => service.DefaultSnoozeDurationInMinutes,
            static (service, value) => service.DefaultSnoozeDurationInMinutes = (int)value!),
        new PreferenceAccessor(
            "NewEventButtonBehavior",
            typeof(NewEventButtonBehavior),
            static service => service.NewEventButtonBehavior,
            static (service, value) => service.NewEventButtonBehavior = (NewEventButtonBehavior)value!),
        new PreferenceAccessor(
            "DefaultNewEventCalendarId",
            typeof(Guid?),
            static service => service.DefaultNewEventCalendarId,
            static (service, value) => service.DefaultNewEventCalendarId = (Guid?)value!),
        new PreferenceAccessor(
            "IsCalendarAccountsGrouped",
            typeof(bool),
            static service => service.IsCalendarAccountsGrouped,
            static (service, value) => service.IsCalendarAccountsGrouped = (bool)value!),
        new PreferenceAccessor(
            "CalendarStartupAccountId",
            typeof(Guid?),
            static service => service.CalendarStartupAccountId,
            static (service, value) => service.CalendarStartupAccountId = (Guid?)value!),
        new PreferenceAccessor(
            "IsCalendarDatePickerExpanded",
            typeof(bool),
            static service => service.IsCalendarDatePickerExpanded,
            static (service, value) => service.IsCalendarDatePickerExpanded = (bool)value!),
        new PreferenceAccessor(
            "CalendarNotificationSoundEvent",
            typeof(NotificationSoundEvent),
            static service => service.CalendarNotificationSoundEvent,
            static (service, value) => service.CalendarNotificationSoundEvent = (NotificationSoundEvent)value!),
        new PreferenceAccessor(
            "CalendarEventDisplayMode",
            typeof(CalendarEventDisplayMode),
            static service => service.CalendarEventDisplayMode,
            static (service, value) => service.CalendarEventDisplayMode = (CalendarEventDisplayMode)value!),
        new PreferenceAccessor(
            "ContactCreationBehavior",
            typeof(NewItemDestinationBehavior),
            static service => service.ContactCreationBehavior,
            static (service, value) => service.ContactCreationBehavior = (NewItemDestinationBehavior)value!),
        new PreferenceAccessor(
            "SpecificContactAddressBookId",
            typeof(Guid?),
            static service => service.SpecificContactAddressBookId,
            static (service, value) => service.SpecificContactAddressBookId = (Guid?)value!),
        new PreferenceAccessor(
            "LastUsedContactAddressBookId",
            typeof(Guid?),
            static service => service.LastUsedContactAddressBookId,
            static (service, value) => service.LastUsedContactAddressBookId = (Guid?)value!),
        new PreferenceAccessor(
            "ContactNameDisplayFormat",
            typeof(ContactNameDisplayFormat),
            static service => service.ContactNameDisplayFormat,
            static (service, value) => service.ContactNameDisplayFormat = (ContactNameDisplayFormat)value!),
        new PreferenceAccessor(
            "ContactSortOrder",
            typeof(ContactSortOrder),
            static service => service.ContactSortOrder,
            static (service, value) => service.ContactSortOrder = (ContactSortOrder)value!),
        new PreferenceAccessor(
            "TaskCreationBehavior",
            typeof(NewItemDestinationBehavior),
            static service => service.TaskCreationBehavior,
            static (service, value) => service.TaskCreationBehavior = (NewItemDestinationBehavior)value!),
        new PreferenceAccessor(
            "SpecificTaskListId",
            typeof(Guid?),
            static service => service.SpecificTaskListId,
            static (service, value) => service.SpecificTaskListId = (Guid?)value!),
        new PreferenceAccessor(
            "LastUsedTaskListId",
            typeof(Guid?),
            static service => service.LastUsedTaskListId,
            static (service, value) => service.LastUsedTaskListId = (Guid?)value!),
        new PreferenceAccessor(
            "ToDoStartView",
            typeof(ToDoStartView),
            static service => service.ToDoStartView,
            static (service, value) => service.ToDoStartView = (ToDoStartView)value!),
        new PreferenceAccessor(
            "ToDoStartTaskListId",
            typeof(Guid?),
            static service => service.ToDoStartTaskListId,
            static (service, value) => service.ToDoStartTaskListId = (Guid?)value!),
        new PreferenceAccessor(
            "CompletedTaskTreatment",
            typeof(CompletedTaskTreatment),
            static service => service.CompletedTaskTreatment,
            static (service, value) => service.CompletedTaskTreatment = (CompletedTaskTreatment)value!),
        new PreferenceAccessor(
            "CompletedTaskHideDelay",
            typeof(CompletedTaskHideDelay),
            static service => service.CompletedTaskHideDelay,
            static (service, value) => service.CompletedTaskHideDelay = (CompletedTaskHideDelay)value!),
        new PreferenceAccessor(
            "IsTaskCompletionSoundEnabled",
            typeof(bool),
            static service => service.IsTaskCompletionSoundEnabled,
            static (service, value) => service.IsTaskCompletionSoundEnabled = (bool)value!),
        new PreferenceAccessor(
            "IsTaskDeleteConfirmationEnabled",
            typeof(bool),
            static service => service.IsTaskDeleteConfirmationEnabled,
            static (service, value) => service.IsTaskDeleteConfirmationEnabled = (bool)value!),
        };
